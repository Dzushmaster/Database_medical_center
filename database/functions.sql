...
create or replace FUNCTION GET_ANALYSES_BY_ID_DOC(ID_ANALYSE ANALYSES.ID_ANALYSE%TYPE) RETURN GET_TAB_ANALYSES PIPELINED
IS
...
create or replace FUNCTION GET_ANALYSES_BY_ID_USER(ID_ANALYSE ANALYSES.ID_ANALYSE%TYPE, ID_USER USER_.ID_USER%TYPE) RETURN GET_TAB_ANALYSES PIPELINED
IS
...
DROP FUNCTION GET_HEALTH; -- USER_DOC
