...
---------------------------------------------------------------------------------------------------------------
DROP FUNCTION GET_ANALYSES_BY_ID_DOC; -- USER_DOC
...
DROP FUNCTION GET_ANALYSES_BY_ID_USER;
...
DROP FUNCTION GET_HOME_ANALYSES_BY_ID; -- USER AND DOC
CREATE OR REPLACE FUNCTION GET_HOME_ANALYSES_BY_ID(ID_USER USER_.ID_USER%TYPE) --USER, DOC
RETURN 
IS
BEGIN
...
DROP FUNCTION GET_HOME_ANALYSES_BY_FULLNAME; 
CREATE OR REPLACE FUNCTION GET_HOME_ANALYSES_BY_FULLNAME(NAME_USER USER_.FULLNAME%TYPE) --DOC
RETURN 
IS
BEGIN
