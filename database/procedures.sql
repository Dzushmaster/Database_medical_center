...
PROCEDURE CREATE_TICKET(ID_USER_ USER_.ID_USER%TYPE, ID_DOC DOCTOR.ID_DOCTOR%TYPE, TIME_VIS HEALTH.DATE_TIME_VISITE%TYPE, RESULT_ OUT NUMBER);
...
CREATE OR REPLACE PACKAGE BODY USER_PROCEDURES IS
    ...
    PROCEDURE CREATE_TICKET(ID_USER_ USER_.ID_USER%TYPE,
    ID_DOC DOCTOR.ID_DOCTOR%TYPE, TIME_VIS HEALTH.DATE_TIME_VISITE%TYPE, RESULT_ OUT NUMBER)
    AS
    ID_US USER_.ID_USER%TYPE;
    ID_DOCT DOCTOR.ID_DOCTOR%TYPE;
    BEGIN
        SELECT USER_.ID_USER INTO ID_US FROM USER_ WHERE ID_USER_ = USER_.ID_USER;
        SELECT DOCTOR.ID_DOCTOR INTO ID_DOCT FROM DOCTOR WHERE ID_DOC = DOCTOR.ID_DOCTOR;
        INSERT INTO HEALTH VALUES(VISITE_ID.NEXTVAL, ID_USER_, ID_DOC, TIME_VIS);
        COMMIT;
